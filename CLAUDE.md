...
**Session Notes:** Idea 4 (Parent Output + Dashboard) Session 2 COMPLETE — Tasks 17+18 design locked. Parent CM: 4 sections (Weekly Context, What Stood Out, What's Ahead, How You Can Support), 150-250 words, Coach Arron third person, support-oriented (no surveillance/monitoring), thematically aligned with athlete CM but never directly references it, no Parent Deep Dive. Dashboard: all live (app + browser), categorical signals only (Overall Signal color, Growth Phase, Weekly Theme, Confidence Direction, Daily Signal), no stress load metric (narrative only), no week-at-a-glance (attendance tracker risk), contributing signals hidden from parents. Daily signal labels: Green=Good Day, Yellow=Building Day, Orange=Reset Day, Gray=No Update Today. Tasks 19-21 deferred to Session 3.
...
- [ ] Task 19: Write Parent Coaching Message specification (Stage 3 expansion) — Session 3 pending
- [ ] Task 20: Write Parent Insights Dashboard specification — pending
- [ ] Task 21: Update Editorial Audit for parent-facing content — pending
